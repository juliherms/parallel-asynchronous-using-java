...
/**
 * This class responsible to implement task recursive with ForkJoin Framework
 */
public class ForkJoinUsingRecursion extends RecursiveTask<List<String>> {
    ...
    /**
     * This methods represents a logic operation
     * @param name
     * @return
     */
    ...
    /**
     * This method responsible to execute logic and recursion.
     * Split the elements from list and configure recursive operation
     * @return
     */
    @Override
